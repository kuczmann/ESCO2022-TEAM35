...
geometry.add_edge(0.009957628346892455, 1e-05, 0.010957628346892456, 1e-05)
geometry.add_edge(0.010957628346892456, 1e-05, 0.010957628346892456, 0.00151)
geometry.add_edge(0.010957628346892456, 0.00151, 0.009957628346892455, 0.00151)
geometry.add_edge(0.009957628346892455, 0.00151, 0.009957628346892455, 1e-05)
geometry.add_edge(0.008366601196702529, 0.00151, 0.009366601196702528, 0.00151)
geometry.add_edge(0.009366601196702528, 0.00151, 0.009366601196702528, 0.00301)
geometry.add_edge(0.009366601196702528, 0.00301, 0.008366601196702529, 0.00301)
geometry.add_edge(0.008366601196702529, 0.00301, 0.008366601196702529, 0.00151)
geometry.add_edge(0.0067249953211268474, 0.00301, 0.0077249953211268475, 0.00301)
geometry.add_edge(0.0077249953211268475, 0.00301, 0.0077249953211268475, 0.00451)
geometry.add_edge(0.0077249953211268475, 0.00451, 0.0067249953211268474, 0.00451)
geometry.add_edge(0.0067249953211268474, 0.00451, 0.0067249953211268474, 0.00301)
geometry.add_edge(0.018688915721108555, 0.00451, 0.019688915721108556, 0.00451)
geometry.add_edge(0.019688915721108556, 0.00451, 0.019688915721108556, 0.00601)
geometry.add_edge(0.019688915721108556, 0.00601, 0.018688915721108555, 0.00601)
geometry.add_edge(0.018688915721108555, 0.00601, 0.018688915721108555, 0.00451)
geometry.add_edge(0.005647615862479663, 0.00601, 0.006647615862479663, 0.00601)
geometry.add_edge(0.006647615862479663, 0.00601, 0.006647615862479663, 0.007509999999999999)
geometry.add_edge(0.006647615862479663, 0.007509999999999999, 0.005647615862479663, 0.007509999999999999)
geometry.add_edge(0.005647615862479663, 0.007509999999999999, 0.005647615862479663, 0.00601)
geometry.add_edge(0.008037959550188203, 0.007509999999999999, 0.009037959550188202, 0.007509999999999999)
geometry.add_edge(0.009037959550188202, 0.007509999999999999, 0.009037959550188202, 0.009009999999999999)
geometry.add_edge(0.009037959550188202, 0.009009999999999999, 0.008037959550188203, 0.009009999999999999)
geometry.add_edge(0.008037959550188203, 0.009009999999999999, 0.008037959550188203, 0.007509999999999999)
geometry.add_edge(0.01209836352957361, 0.00901, 0.013098363529573609, 0.00901)
geometry.add_edge(0.013098363529573609, 0.00901, 0.013098363529573609, 0.01051)
geometry.add_edge(0.013098363529573609, 0.01051, 0.01209836352957361, 0.01051)
geometry.add_edge(0.01209836352957361, 0.01051, 0.01209836352957361, 0.00901)
geometry.add_edge(0.012738284609164435, 0.01051, 0.013738284609164434, 0.01051)
geometry.add_edge(0.013738284609164434, 0.01051, 0.013738284609164434, 0.01201)
geometry.add_edge(0.013738284609164434, 0.01201, 0.012738284609164435, 0.01201)
geometry.add_edge(0.012738284609164435, 0.01201, 0.012738284609164435, 0.01051)
geometry.add_edge(0.014037460800325956, 0.01201, 0.015037460800325957, 0.01201)
geometry.add_edge(0.015037460800325957, 0.01201, 0.015037460800325957, 0.01351)
geometry.add_edge(0.015037460800325957, 0.01351, 0.014037460800325956, 0.01351)
geometry.add_edge(0.014037460800325956, 0.01351, 0.014037460800325956, 0.01201)
geometry.add_edge(0.010193971998134642, 0.01351, 0.011193971998134641, 0.01351)
geometry.add_edge(0.011193971998134641, 0.01351, 0.011193971998134641, 0.015009999999999999)
geometry.add_edge(0.011193971998134641, 0.015009999999999999, 0.010193971998134642, 0.015009999999999999)
geometry.add_edge(0.010193971998134642, 0.015009999999999999, 0.010193971998134642, 0.01351)

# BLOCK LABELS
geometry.add_label(0.010457628346892456, 0.00076, materials = {'magnetic' : 'turn_0'})
labels.append((0.010457628346892456, 0.00076))
geometry.add_label(0.008866601196702528, 0.0022600000000000003, materials = {'magnetic' : 'turn_1'})
labels.append((0.008866601196702528, 0.0022600000000000003))
geometry.add_label(0.007224995321126848, 0.0037600000000000003, materials = {'magnetic' : 'turn_2'})
labels.append((0.007224995321126848, 0.0037600000000000003))
geometry.add_label(0.019188915721108556, 0.00526, materials = {'magnetic' : 'turn_3'})
labels.append((0.019188915721108556, 0.00526))
geometry.add_label(0.006147615862479663, 0.0067599999999999995, materials = {'magnetic' : 'turn_4'})
labels.append((0.006147615862479663, 0.0067599999999999995))
geometry.add_label(0.008537959550188202, 0.008259999999999998, materials = {'magnetic' : 'turn_5'})
labels.append((0.008537959550188202, 0.008259999999999998))
geometry.add_label(0.012598363529573608, 0.00976, materials = {'magnetic' : 'turn_6'})
labels.append((0.012598363529573608, 0.00976))
geometry.add_label(0.013238284609164435, 0.011260000000000001, materials = {'magnetic' : 'turn_7'})
labels.append((0.013238284609164435, 0.011260000000000001))
geometry.add_label(0.014537460800325957, 0.01276, materials = {'magnetic' : 'turn_8'})
labels.append((0.014537460800325957, 0.01276))
geometry.add_label(0.010693971998134641, 0.014259999999999998, materials = {'magnetic' : 'turn_9'})
labels.append((0.010693971998134641, 0.014259999999999998))
...
f = open(r"/home/kuczmann/ESCO2022-TEAM35/src/snapshots/6c2acfeb-a142-4faf-806f-058c1afd7a22/S_6c2acfeb-a142-4faf-806f-058c1afd7a22.csv", "w")
