...
geometry.add_edge(0.009074087766998284, 1e-05, 0.010074087766998283, 1e-05)
geometry.add_edge(0.010074087766998283, 1e-05, 0.010074087766998283, 0.00151)
geometry.add_edge(0.010074087766998283, 0.00151, 0.009074087766998284, 0.00151)
geometry.add_edge(0.009074087766998284, 0.00151, 0.009074087766998284, 1e-05)
geometry.add_edge(0.007513752420336946, 0.00151, 0.008513752420336945, 0.00151)
geometry.add_edge(0.008513752420336945, 0.00151, 0.008513752420336945, 0.00301)
geometry.add_edge(0.008513752420336945, 0.00301, 0.007513752420336946, 0.00301)
geometry.add_edge(0.007513752420336946, 0.00301, 0.007513752420336946, 0.00151)
geometry.add_edge(0.023182906152030676, 0.00301, 0.024182906152030677, 0.00301)
geometry.add_edge(0.024182906152030677, 0.00301, 0.024182906152030677, 0.00451)
geometry.add_edge(0.024182906152030677, 0.00451, 0.023182906152030676, 0.00451)
geometry.add_edge(0.023182906152030676, 0.00451, 0.023182906152030676, 0.00301)
geometry.add_edge(0.023736914255046357, 0.00451, 0.024736914255046358, 0.00451)
geometry.add_edge(0.024736914255046358, 0.00451, 0.024736914255046358, 0.00601)
geometry.add_edge(0.024736914255046358, 0.00601, 0.023736914255046357, 0.00601)
geometry.add_edge(0.023736914255046357, 0.00601, 0.023736914255046357, 0.00451)
geometry.add_edge(0.018793925965964933, 0.00601, 0.019793925965964933, 0.00601)
geometry.add_edge(0.019793925965964933, 0.00601, 0.019793925965964933, 0.007509999999999999)
geometry.add_edge(0.019793925965964933, 0.007509999999999999, 0.018793925965964933, 0.007509999999999999)
geometry.add_edge(0.018793925965964933, 0.007509999999999999, 0.018793925965964933, 0.00601)
geometry.add_edge(0.008041345250633065, 0.007509999999999999, 0.009041345250633066, 0.007509999999999999)
geometry.add_edge(0.009041345250633066, 0.007509999999999999, 0.009041345250633066, 0.009009999999999999)
geometry.add_edge(0.009041345250633066, 0.009009999999999999, 0.008041345250633065, 0.009009999999999999)
geometry.add_edge(0.008041345250633065, 0.009009999999999999, 0.008041345250633065, 0.007509999999999999)
geometry.add_edge(0.012575501489911302, 0.00901, 0.013575501489911303, 0.00901)
geometry.add_edge(0.013575501489911303, 0.00901, 0.013575501489911303, 0.01051)
geometry.add_edge(0.013575501489911303, 0.01051, 0.012575501489911302, 0.01051)
geometry.add_edge(0.012575501489911302, 0.01051, 0.012575501489911302, 0.00901)
geometry.add_edge(0.011162491690841042, 0.01051, 0.012162491690841042, 0.01051)
geometry.add_edge(0.012162491690841042, 0.01051, 0.012162491690841042, 0.01201)
geometry.add_edge(0.012162491690841042, 0.01201, 0.011162491690841042, 0.01201)
geometry.add_edge(0.011162491690841042, 0.01201, 0.011162491690841042, 0.01051)
geometry.add_edge(0.015382971225288672, 0.01201, 0.016382971225288673, 0.01201)
geometry.add_edge(0.016382971225288673, 0.01201, 0.016382971225288673, 0.01351)
geometry.add_edge(0.016382971225288673, 0.01351, 0.015382971225288672, 0.01351)
geometry.add_edge(0.015382971225288672, 0.01351, 0.015382971225288672, 0.01201)
geometry.add_edge(0.010533870573926728, 0.01351, 0.011533870573926727, 0.01351)
geometry.add_edge(0.011533870573926727, 0.01351, 0.011533870573926727, 0.015009999999999999)
geometry.add_edge(0.011533870573926727, 0.015009999999999999, 0.010533870573926728, 0.015009999999999999)
geometry.add_edge(0.010533870573926728, 0.015009999999999999, 0.010533870573926728, 0.01351)

# BLOCK LABELS
geometry.add_label(0.009574087766998283, 0.00076, materials = {'magnetic' : 'turn_0'})
labels.append((0.009574087766998283, 0.00076))
geometry.add_label(0.008013752420336945, 0.0022600000000000003, materials = {'magnetic' : 'turn_1'})
labels.append((0.008013752420336945, 0.0022600000000000003))
geometry.add_label(0.023682906152030676, 0.0037600000000000003, materials = {'magnetic' : 'turn_2'})
labels.append((0.023682906152030676, 0.0037600000000000003))
geometry.add_label(0.024236914255046357, 0.00526, materials = {'magnetic' : 'turn_3'})
labels.append((0.024236914255046357, 0.00526))
geometry.add_label(0.019293925965964933, 0.0067599999999999995, materials = {'magnetic' : 'turn_4'})
labels.append((0.019293925965964933, 0.0067599999999999995))
geometry.add_label(0.008541345250633065, 0.008259999999999998, materials = {'magnetic' : 'turn_5'})
labels.append((0.008541345250633065, 0.008259999999999998))
geometry.add_label(0.013075501489911302, 0.00976, materials = {'magnetic' : 'turn_6'})
labels.append((0.013075501489911302, 0.00976))
geometry.add_label(0.011662491690841041, 0.011260000000000001, materials = {'magnetic' : 'turn_7'})
labels.append((0.011662491690841041, 0.011260000000000001))
geometry.add_label(0.015882971225288672, 0.01276, materials = {'magnetic' : 'turn_8'})
labels.append((0.015882971225288672, 0.01276))
geometry.add_label(0.011033870573926727, 0.014259999999999998, materials = {'magnetic' : 'turn_9'})
labels.append((0.011033870573926727, 0.014259999999999998))
...
f = open(r"/home/kuczmann/ESCO2022-TEAM35/src/snapshots/ce60af9d-f313-4bb9-8cb8-633f7eb4094a/S_ce60af9d-f313-4bb9-8cb8-633f7eb4094a.csv", "w")
