...
geometry.add_edge(0.009389517418380624, 1e-05, 0.010389517418380623, 1e-05)
geometry.add_edge(0.010389517418380623, 1e-05, 0.010389517418380623, 0.00151)
geometry.add_edge(0.010389517418380623, 0.00151, 0.009389517418380624, 0.00151)
geometry.add_edge(0.009389517418380624, 0.00151, 0.009389517418380624, 1e-05)
geometry.add_edge(0.007025045973119564, 0.00151, 0.008025045973119564, 0.00151)
geometry.add_edge(0.008025045973119564, 0.00151, 0.008025045973119564, 0.00301)
geometry.add_edge(0.008025045973119564, 0.00301, 0.007025045973119564, 0.00301)
geometry.add_edge(0.007025045973119564, 0.00301, 0.007025045973119564, 0.00151)
geometry.add_edge(0.02010146515030579, 0.00301, 0.021101465150305792, 0.00301)
geometry.add_edge(0.021101465150305792, 0.00301, 0.021101465150305792, 0.00451)
geometry.add_edge(0.021101465150305792, 0.00451, 0.02010146515030579, 0.00451)
geometry.add_edge(0.02010146515030579, 0.00451, 0.02010146515030579, 0.00301)
geometry.add_edge(0.01919428142248184, 0.00451, 0.020194281422481843, 0.00451)
geometry.add_edge(0.020194281422481843, 0.00451, 0.020194281422481843, 0.00601)
geometry.add_edge(0.020194281422481843, 0.00601, 0.01919428142248184, 0.00601)
geometry.add_edge(0.01919428142248184, 0.00601, 0.01919428142248184, 0.00451)
geometry.add_edge(0.018002970883834048, 0.00601, 0.01900297088383405, 0.00601)
geometry.add_edge(0.01900297088383405, 0.00601, 0.01900297088383405, 0.007509999999999999)
geometry.add_edge(0.01900297088383405, 0.007509999999999999, 0.018002970883834048, 0.007509999999999999)
geometry.add_edge(0.018002970883834048, 0.007509999999999999, 0.018002970883834048, 0.00601)
geometry.add_edge(0.0075220859882427936, 0.007509999999999999, 0.008522085988242794, 0.007509999999999999)
geometry.add_edge(0.008522085988242794, 0.007509999999999999, 0.008522085988242794, 0.009009999999999999)
geometry.add_edge(0.008522085988242794, 0.009009999999999999, 0.0075220859882427936, 0.009009999999999999)
geometry.add_edge(0.0075220859882427936, 0.009009999999999999, 0.0075220859882427936, 0.007509999999999999)
geometry.add_edge(0.010627383979772888, 0.00901, 0.01162738397977289, 0.00901)
geometry.add_edge(0.01162738397977289, 0.00901, 0.01162738397977289, 0.01051)
geometry.add_edge(0.01162738397977289, 0.01051, 0.010627383979772888, 0.01051)
geometry.add_edge(0.010627383979772888, 0.01051, 0.010627383979772888, 0.00901)
geometry.add_edge(0.009653309206855318, 0.01051, 0.010653309206855317, 0.01051)
geometry.add_edge(0.010653309206855317, 0.01051, 0.010653309206855317, 0.01201)
geometry.add_edge(0.010653309206855317, 0.01201, 0.009653309206855318, 0.01201)
geometry.add_edge(0.009653309206855318, 0.01201, 0.009653309206855318, 0.01051)
geometry.add_edge(0.016117700105175953, 0.01201, 0.017117700105175954, 0.01201)
geometry.add_edge(0.017117700105175954, 0.01201, 0.017117700105175954, 0.01351)
geometry.add_edge(0.017117700105175954, 0.01351, 0.016117700105175953, 0.01351)
geometry.add_edge(0.016117700105175953, 0.01351, 0.016117700105175953, 0.01201)
geometry.add_edge(0.01047043878070357, 0.01351, 0.01147043878070357, 0.01351)
geometry.add_edge(0.01147043878070357, 0.01351, 0.01147043878070357, 0.015009999999999999)
geometry.add_edge(0.01147043878070357, 0.015009999999999999, 0.01047043878070357, 0.015009999999999999)
geometry.add_edge(0.01047043878070357, 0.015009999999999999, 0.01047043878070357, 0.01351)

# BLOCK LABELS
geometry.add_label(0.009889517418380622, 0.00076, materials = {'magnetic' : 'turn_0'})
labels.append((0.009889517418380622, 0.00076))
geometry.add_label(0.007525045973119563, 0.0022600000000000003, materials = {'magnetic' : 'turn_1'})
labels.append((0.007525045973119563, 0.0022600000000000003))
geometry.add_label(0.02060146515030579, 0.0037600000000000003, materials = {'magnetic' : 'turn_2'})
labels.append((0.02060146515030579, 0.0037600000000000003))
geometry.add_label(0.019694281422481842, 0.00526, materials = {'magnetic' : 'turn_3'})
labels.append((0.019694281422481842, 0.00526))
geometry.add_label(0.018502970883834048, 0.0067599999999999995, materials = {'magnetic' : 'turn_4'})
labels.append((0.018502970883834048, 0.0067599999999999995))
geometry.add_label(0.008022085988242793, 0.008259999999999998, materials = {'magnetic' : 'turn_5'})
labels.append((0.008022085988242793, 0.008259999999999998))
geometry.add_label(0.011127383979772889, 0.00976, materials = {'magnetic' : 'turn_6'})
labels.append((0.011127383979772889, 0.00976))
geometry.add_label(0.010153309206855317, 0.011260000000000001, materials = {'magnetic' : 'turn_7'})
labels.append((0.010153309206855317, 0.011260000000000001))
geometry.add_label(0.016617700105175954, 0.01276, materials = {'magnetic' : 'turn_8'})
labels.append((0.016617700105175954, 0.01276))
geometry.add_label(0.01097043878070357, 0.014259999999999998, materials = {'magnetic' : 'turn_9'})
labels.append((0.01097043878070357, 0.014259999999999998))
...
f = open(r"/home/kuczmann/ESCO2022-TEAM35/src/snapshots/1fc62711-814d-4210-9703-7ea48281b58a/S_1fc62711-814d-4210-9703-7ea48281b58a.csv", "w")
