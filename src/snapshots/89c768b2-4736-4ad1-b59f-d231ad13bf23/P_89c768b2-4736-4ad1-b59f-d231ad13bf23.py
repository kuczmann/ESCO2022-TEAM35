...
geometry.add_edge(0.009946608294678288, 1e-05, 0.010946608294678289, 1e-05)
geometry.add_edge(0.010946608294678289, 1e-05, 0.010946608294678289, 0.00151)
geometry.add_edge(0.010946608294678289, 0.00151, 0.009946608294678288, 0.00151)
geometry.add_edge(0.009946608294678288, 0.00151, 0.009946608294678288, 1e-05)
geometry.add_edge(0.008692308739881503, 0.00151, 0.009692308739881503, 0.00151)
geometry.add_edge(0.009692308739881503, 0.00151, 0.009692308739881503, 0.00301)
geometry.add_edge(0.009692308739881503, 0.00301, 0.008692308739881503, 0.00301)
geometry.add_edge(0.008692308739881503, 0.00301, 0.008692308739881503, 0.00151)
geometry.add_edge(0.014098411309364723, 0.00301, 0.015098411309364724, 0.00301)
geometry.add_edge(0.015098411309364724, 0.00301, 0.015098411309364724, 0.00451)
geometry.add_edge(0.015098411309364724, 0.00451, 0.014098411309364723, 0.00451)
geometry.add_edge(0.014098411309364723, 0.00451, 0.014098411309364723, 0.00301)
geometry.add_edge(0.00971937643926473, 0.00451, 0.010719376439264731, 0.00451)
geometry.add_edge(0.010719376439264731, 0.00451, 0.010719376439264731, 0.00601)
geometry.add_edge(0.010719376439264731, 0.00601, 0.00971937643926473, 0.00601)
geometry.add_edge(0.00971937643926473, 0.00601, 0.00971937643926473, 0.00451)
geometry.add_edge(0.0053120771952959184, 0.00601, 0.0063120771952959185, 0.00601)
geometry.add_edge(0.0063120771952959185, 0.00601, 0.0063120771952959185, 0.007509999999999999)
geometry.add_edge(0.0063120771952959185, 0.007509999999999999, 0.0053120771952959184, 0.007509999999999999)
geometry.add_edge(0.0053120771952959184, 0.007509999999999999, 0.0053120771952959184, 0.00601)
geometry.add_edge(0.006871341541747169, 0.007509999999999999, 0.007871341541747168, 0.007509999999999999)
geometry.add_edge(0.007871341541747168, 0.007509999999999999, 0.007871341541747168, 0.009009999999999999)
geometry.add_edge(0.007871341541747168, 0.009009999999999999, 0.006871341541747169, 0.009009999999999999)
geometry.add_edge(0.006871341541747169, 0.009009999999999999, 0.006871341541747169, 0.007509999999999999)
geometry.add_edge(0.011577748401782353, 0.00901, 0.012577748401782354, 0.00901)
geometry.add_edge(0.012577748401782354, 0.00901, 0.012577748401782354, 0.01051)
geometry.add_edge(0.012577748401782354, 0.01051, 0.011577748401782353, 0.01051)
geometry.add_edge(0.011577748401782353, 0.01051, 0.011577748401782353, 0.00901)
geometry.add_edge(0.012361167742507423, 0.01051, 0.013361167742507424, 0.01051)
geometry.add_edge(0.013361167742507424, 0.01051, 0.013361167742507424, 0.01201)
geometry.add_edge(0.013361167742507424, 0.01201, 0.012361167742507423, 0.01201)
geometry.add_edge(0.012361167742507423, 0.01201, 0.012361167742507423, 0.01051)
geometry.add_edge(0.014810402818506142, 0.01201, 0.015810402818506143, 0.01201)
geometry.add_edge(0.015810402818506143, 0.01201, 0.015810402818506143, 0.01351)
geometry.add_edge(0.015810402818506143, 0.01351, 0.014810402818506142, 0.01351)
geometry.add_edge(0.014810402818506142, 0.01351, 0.014810402818506142, 0.01201)
geometry.add_edge(0.009657113917216426, 0.01351, 0.010657113917216427, 0.01351)
geometry.add_edge(0.010657113917216427, 0.01351, 0.010657113917216427, 0.015009999999999999)
geometry.add_edge(0.010657113917216427, 0.015009999999999999, 0.009657113917216426, 0.015009999999999999)
geometry.add_edge(0.009657113917216426, 0.015009999999999999, 0.009657113917216426, 0.01351)

# BLOCK LABELS
geometry.add_label(0.010446608294678288, 0.00076, materials = {'magnetic' : 'turn_0'})
labels.append((0.010446608294678288, 0.00076))
geometry.add_label(0.009192308739881503, 0.0022600000000000003, materials = {'magnetic' : 'turn_1'})
labels.append((0.009192308739881503, 0.0022600000000000003))
geometry.add_label(0.014598411309364723, 0.0037600000000000003, materials = {'magnetic' : 'turn_2'})
labels.append((0.014598411309364723, 0.0037600000000000003))
geometry.add_label(0.010219376439264731, 0.00526, materials = {'magnetic' : 'turn_3'})
labels.append((0.010219376439264731, 0.00526))
geometry.add_label(0.005812077195295919, 0.0067599999999999995, materials = {'magnetic' : 'turn_4'})
labels.append((0.005812077195295919, 0.0067599999999999995))
geometry.add_label(0.00737134154174717, 0.008259999999999998, materials = {'magnetic' : 'turn_5'})
labels.append((0.00737134154174717, 0.008259999999999998))
geometry.add_label(0.012077748401782353, 0.00976, materials = {'magnetic' : 'turn_6'})
labels.append((0.012077748401782353, 0.00976))
geometry.add_label(0.012861167742507423, 0.011260000000000001, materials = {'magnetic' : 'turn_7'})
labels.append((0.012861167742507423, 0.011260000000000001))
geometry.add_label(0.015310402818506142, 0.01276, materials = {'magnetic' : 'turn_8'})
labels.append((0.015310402818506142, 0.01276))
geometry.add_label(0.010157113917216427, 0.014259999999999998, materials = {'magnetic' : 'turn_9'})
labels.append((0.010157113917216427, 0.014259999999999998))
...
f = open(r"/home/kuczmann/ESCO2022-TEAM35/src/snapshots/89c768b2-4736-4ad1-b59f-d231ad13bf23/S_89c768b2-4736-4ad1-b59f-d231ad13bf23.csv", "w")
