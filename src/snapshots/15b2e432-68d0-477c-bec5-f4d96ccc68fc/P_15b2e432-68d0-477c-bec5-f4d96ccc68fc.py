...
geometry.add_edge(0.022197280478222347, 1e-05, 0.023197280478222348, 1e-05)
geometry.add_edge(0.023197280478222348, 1e-05, 0.023197280478222348, 0.00151)
geometry.add_edge(0.023197280478222348, 0.00151, 0.022197280478222347, 0.00151)
geometry.add_edge(0.022197280478222347, 0.00151, 0.022197280478222347, 1e-05)
geometry.add_edge(0.00602319040142746, 0.00151, 0.00702319040142746, 0.00151)
geometry.add_edge(0.00702319040142746, 0.00151, 0.00702319040142746, 0.00301)
geometry.add_edge(0.00702319040142746, 0.00301, 0.00602319040142746, 0.00301)
geometry.add_edge(0.00602319040142746, 0.00301, 0.00602319040142746, 0.00151)
geometry.add_edge(0.011398565784802582, 0.00301, 0.01239856578480258, 0.00301)
geometry.add_edge(0.01239856578480258, 0.00301, 0.01239856578480258, 0.00451)
geometry.add_edge(0.01239856578480258, 0.00451, 0.011398565784802582, 0.00451)
geometry.add_edge(0.011398565784802582, 0.00451, 0.011398565784802582, 0.00301)
geometry.add_edge(0.024501558072208156, 0.00451, 0.025501558072208157, 0.00451)
geometry.add_edge(0.025501558072208157, 0.00451, 0.025501558072208157, 0.00601)
geometry.add_edge(0.025501558072208157, 0.00601, 0.024501558072208156, 0.00601)
geometry.add_edge(0.024501558072208156, 0.00601, 0.024501558072208156, 0.00451)
geometry.add_edge(0.00871146118448927, 0.00601, 0.009711461184489269, 0.00601)
geometry.add_edge(0.009711461184489269, 0.00601, 0.009711461184489269, 0.007509999999999999)
geometry.add_edge(0.009711461184489269, 0.007509999999999999, 0.00871146118448927, 0.007509999999999999)
geometry.add_edge(0.00871146118448927, 0.007509999999999999, 0.00871146118448927, 0.00601)
geometry.add_edge(0.008611335689121582, 0.007509999999999999, 0.009611335689121581, 0.007509999999999999)
geometry.add_edge(0.009611335689121581, 0.007509999999999999, 0.009611335689121581, 0.009009999999999999)
geometry.add_edge(0.009611335689121581, 0.009009999999999999, 0.008611335689121582, 0.009009999999999999)
geometry.add_edge(0.008611335689121582, 0.009009999999999999, 0.008611335689121582, 0.007509999999999999)
geometry.add_edge(0.013039882590215445, 0.00901, 0.014039882590215446, 0.00901)
geometry.add_edge(0.014039882590215446, 0.00901, 0.014039882590215446, 0.01051)
geometry.add_edge(0.014039882590215446, 0.01051, 0.013039882590215445, 0.01051)
geometry.add_edge(0.013039882590215445, 0.01051, 0.013039882590215445, 0.00901)
geometry.add_edge(0.011730151648574253, 0.01051, 0.012730151648574252, 0.01051)
geometry.add_edge(0.012730151648574252, 0.01051, 0.012730151648574252, 0.01201)
geometry.add_edge(0.012730151648574252, 0.01201, 0.011730151648574253, 0.01201)
geometry.add_edge(0.011730151648574253, 0.01201, 0.011730151648574253, 0.01051)
geometry.add_edge(0.014031944768547884, 0.01201, 0.015031944768547884, 0.01201)
geometry.add_edge(0.015031944768547884, 0.01201, 0.015031944768547884, 0.01351)
geometry.add_edge(0.015031944768547884, 0.01351, 0.014031944768547884, 0.01351)
geometry.add_edge(0.014031944768547884, 0.01351, 0.014031944768547884, 0.01201)
geometry.add_edge(0.014796326082756132, 0.01351, 0.01579632608275613, 0.01351)
geometry.add_edge(0.01579632608275613, 0.01351, 0.01579632608275613, 0.015009999999999999)
geometry.add_edge(0.01579632608275613, 0.015009999999999999, 0.014796326082756132, 0.015009999999999999)
geometry.add_edge(0.014796326082756132, 0.015009999999999999, 0.014796326082756132, 0.01351)

# BLOCK LABELS
geometry.add_label(0.022697280478222347, 0.00076, materials = {'magnetic' : 'turn_0'})
labels.append((0.022697280478222347, 0.00076))
geometry.add_label(0.006523190401427461, 0.0022600000000000003, materials = {'magnetic' : 'turn_1'})
labels.append((0.006523190401427461, 0.0022600000000000003))
geometry.add_label(0.01189856578480258, 0.0037600000000000003, materials = {'magnetic' : 'turn_2'})
labels.append((0.01189856578480258, 0.0037600000000000003))
geometry.add_label(0.025001558072208156, 0.00526, materials = {'magnetic' : 'turn_3'})
labels.append((0.025001558072208156, 0.00526))
geometry.add_label(0.009211461184489268, 0.0067599999999999995, materials = {'magnetic' : 'turn_4'})
labels.append((0.009211461184489268, 0.0067599999999999995))
geometry.add_label(0.009111335689121581, 0.008259999999999998, materials = {'magnetic' : 'turn_5'})
labels.append((0.009111335689121581, 0.008259999999999998))
geometry.add_label(0.013539882590215446, 0.00976, materials = {'magnetic' : 'turn_6'})
labels.append((0.013539882590215446, 0.00976))
geometry.add_label(0.012230151648574251, 0.011260000000000001, materials = {'magnetic' : 'turn_7'})
labels.append((0.012230151648574251, 0.011260000000000001))
geometry.add_label(0.014531944768547883, 0.01276, materials = {'magnetic' : 'turn_8'})
labels.append((0.014531944768547883, 0.01276))
geometry.add_label(0.01529632608275613, 0.014259999999999998, materials = {'magnetic' : 'turn_9'})
labels.append((0.01529632608275613, 0.014259999999999998))
...
f = open(r"/home/kuczmann/ESCO2022-TEAM35/src/snapshots/15b2e432-68d0-477c-bec5-f4d96ccc68fc/S_15b2e432-68d0-477c-bec5-f4d96ccc68fc.csv", "w")
