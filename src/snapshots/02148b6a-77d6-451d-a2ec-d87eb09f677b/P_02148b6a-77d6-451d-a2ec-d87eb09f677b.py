...
geometry.add_edge(0.008594875359788487, 1e-05, 0.009594875359788486, 1e-05)
geometry.add_edge(0.009594875359788486, 1e-05, 0.009594875359788486, 0.00151)
geometry.add_edge(0.009594875359788486, 0.00151, 0.008594875359788487, 0.00151)
geometry.add_edge(0.008594875359788487, 0.00151, 0.008594875359788487, 1e-05)
geometry.add_edge(0.007016640054677606, 0.00151, 0.008016640054677606, 0.00151)
geometry.add_edge(0.008016640054677606, 0.00151, 0.008016640054677606, 0.00301)
geometry.add_edge(0.008016640054677606, 0.00301, 0.007016640054677606, 0.00301)
geometry.add_edge(0.007016640054677606, 0.00301, 0.007016640054677606, 0.00151)
geometry.add_edge(0.021318449118387543, 0.00301, 0.022318449118387543, 0.00301)
geometry.add_edge(0.022318449118387543, 0.00301, 0.022318449118387543, 0.00451)
geometry.add_edge(0.022318449118387543, 0.00451, 0.021318449118387543, 0.00451)
geometry.add_edge(0.021318449118387543, 0.00451, 0.021318449118387543, 0.00301)
geometry.add_edge(0.021184138894641394, 0.00451, 0.022184138894641395, 0.00451)
geometry.add_edge(0.022184138894641395, 0.00451, 0.022184138894641395, 0.00601)
geometry.add_edge(0.022184138894641395, 0.00601, 0.021184138894641394, 0.00601)
geometry.add_edge(0.021184138894641394, 0.00601, 0.021184138894641394, 0.00451)
geometry.add_edge(0.019761103775801595, 0.00601, 0.020761103775801596, 0.00601)
geometry.add_edge(0.020761103775801596, 0.00601, 0.020761103775801596, 0.007509999999999999)
geometry.add_edge(0.020761103775801596, 0.007509999999999999, 0.019761103775801595, 0.007509999999999999)
geometry.add_edge(0.019761103775801595, 0.007509999999999999, 0.019761103775801595, 0.00601)
geometry.add_edge(0.007956587054903605, 0.007509999999999999, 0.008956587054903604, 0.007509999999999999)
geometry.add_edge(0.008956587054903604, 0.007509999999999999, 0.008956587054903604, 0.009009999999999999)
geometry.add_edge(0.008956587054903604, 0.009009999999999999, 0.007956587054903605, 0.009009999999999999)
geometry.add_edge(0.007956587054903605, 0.009009999999999999, 0.007956587054903605, 0.007509999999999999)
geometry.add_edge(0.009881995646251116, 0.00901, 0.010881995646251117, 0.00901)
geometry.add_edge(0.010881995646251117, 0.00901, 0.010881995646251117, 0.01051)
geometry.add_edge(0.010881995646251117, 0.01051, 0.009881995646251116, 0.01051)
geometry.add_edge(0.009881995646251116, 0.01051, 0.009881995646251116, 0.00901)
geometry.add_edge(0.011693103105841856, 0.01051, 0.012693103105841857, 0.01051)
geometry.add_edge(0.012693103105841857, 0.01051, 0.012693103105841857, 0.01201)
geometry.add_edge(0.012693103105841857, 0.01201, 0.011693103105841856, 0.01201)
geometry.add_edge(0.011693103105841856, 0.01201, 0.011693103105841856, 0.01051)
geometry.add_edge(0.01518545524474634, 0.01201, 0.01618545524474634, 0.01201)
geometry.add_edge(0.01618545524474634, 0.01201, 0.01618545524474634, 0.01351)
geometry.add_edge(0.01618545524474634, 0.01351, 0.01518545524474634, 0.01351)
geometry.add_edge(0.01518545524474634, 0.01351, 0.01518545524474634, 0.01201)
geometry.add_edge(0.010248141306816888, 0.01351, 0.011248141306816888, 0.01351)
geometry.add_edge(0.011248141306816888, 0.01351, 0.011248141306816888, 0.015009999999999999)
geometry.add_edge(0.011248141306816888, 0.015009999999999999, 0.010248141306816888, 0.015009999999999999)
geometry.add_edge(0.010248141306816888, 0.015009999999999999, 0.010248141306816888, 0.01351)

# BLOCK LABELS
geometry.add_label(0.009094875359788486, 0.00076, materials = {'magnetic' : 'turn_0'})
labels.append((0.009094875359788486, 0.00076))
geometry.add_label(0.007516640054677606, 0.0022600000000000003, materials = {'magnetic' : 'turn_1'})
labels.append((0.007516640054677606, 0.0022600000000000003))
geometry.add_label(0.021818449118387543, 0.0037600000000000003, materials = {'magnetic' : 'turn_2'})
labels.append((0.021818449118387543, 0.0037600000000000003))
geometry.add_label(0.021684138894641394, 0.00526, materials = {'magnetic' : 'turn_3'})
labels.append((0.021684138894641394, 0.00526))
geometry.add_label(0.020261103775801596, 0.0067599999999999995, materials = {'magnetic' : 'turn_4'})
labels.append((0.020261103775801596, 0.0067599999999999995))
geometry.add_label(0.008456587054903604, 0.008259999999999998, materials = {'magnetic' : 'turn_5'})
labels.append((0.008456587054903604, 0.008259999999999998))
geometry.add_label(0.010381995646251117, 0.00976, materials = {'magnetic' : 'turn_6'})
labels.append((0.010381995646251117, 0.00976))
geometry.add_label(0.012193103105841856, 0.011260000000000001, materials = {'magnetic' : 'turn_7'})
labels.append((0.012193103105841856, 0.011260000000000001))
geometry.add_label(0.01568545524474634, 0.01276, materials = {'magnetic' : 'turn_8'})
labels.append((0.01568545524474634, 0.01276))
geometry.add_label(0.010748141306816887, 0.014259999999999998, materials = {'magnetic' : 'turn_9'})
labels.append((0.010748141306816887, 0.014259999999999998))
...
f = open(r"/home/kuczmann/ESCO2022-TEAM35/src/snapshots/02148b6a-77d6-451d-a2ec-d87eb09f677b/S_02148b6a-77d6-451d-a2ec-d87eb09f677b.csv", "w")
