...
geometry.add_edge(0.008189241303364486, 1e-05, 0.009189241303364487, 1e-05)
geometry.add_edge(0.009189241303364487, 1e-05, 0.009189241303364487, 0.00151)
geometry.add_edge(0.009189241303364487, 0.00151, 0.008189241303364486, 0.00151)
geometry.add_edge(0.008189241303364486, 0.00151, 0.008189241303364486, 1e-05)
geometry.add_edge(0.007020029390105492, 0.00151, 0.008020029390105491, 0.00151)
geometry.add_edge(0.008020029390105491, 0.00151, 0.008020029390105491, 0.00301)
geometry.add_edge(0.008020029390105491, 0.00301, 0.007020029390105492, 0.00301)
geometry.add_edge(0.007020029390105492, 0.00301, 0.007020029390105492, 0.00151)
geometry.add_edge(0.013162012651098834, 0.00301, 0.014162012651098833, 0.00301)
geometry.add_edge(0.014162012651098833, 0.00301, 0.014162012651098833, 0.00451)
geometry.add_edge(0.014162012651098833, 0.00451, 0.013162012651098834, 0.00451)
geometry.add_edge(0.013162012651098834, 0.00451, 0.013162012651098834, 0.00301)
geometry.add_edge(0.02465634001044162, 0.00451, 0.02565634001044162, 0.00451)
geometry.add_edge(0.02565634001044162, 0.00451, 0.02565634001044162, 0.00601)
geometry.add_edge(0.02565634001044162, 0.00601, 0.02465634001044162, 0.00601)
geometry.add_edge(0.02465634001044162, 0.00601, 0.02465634001044162, 0.00451)
geometry.add_edge(0.02009299556957649, 0.00601, 0.02109299556957649, 0.00601)
geometry.add_edge(0.02109299556957649, 0.00601, 0.02109299556957649, 0.007509999999999999)
geometry.add_edge(0.02109299556957649, 0.007509999999999999, 0.02009299556957649, 0.007509999999999999)
geometry.add_edge(0.02009299556957649, 0.007509999999999999, 0.02009299556957649, 0.00601)
geometry.add_edge(0.009528631008850022, 0.007509999999999999, 0.010528631008850022, 0.007509999999999999)
geometry.add_edge(0.010528631008850022, 0.007509999999999999, 0.010528631008850022, 0.009009999999999999)
geometry.add_edge(0.010528631008850022, 0.009009999999999999, 0.009528631008850022, 0.009009999999999999)
geometry.add_edge(0.009528631008850022, 0.009009999999999999, 0.009528631008850022, 0.007509999999999999)
geometry.add_edge(0.013087186688659692, 0.00901, 0.014087186688659693, 0.00901)
geometry.add_edge(0.014087186688659693, 0.00901, 0.014087186688659693, 0.01051)
geometry.add_edge(0.014087186688659693, 0.01051, 0.013087186688659692, 0.01051)
geometry.add_edge(0.013087186688659692, 0.01051, 0.013087186688659692, 0.00901)
geometry.add_edge(0.012627680317496573, 0.01051, 0.013627680317496574, 0.01051)
geometry.add_edge(0.013627680317496574, 0.01051, 0.013627680317496574, 0.01201)
geometry.add_edge(0.013627680317496574, 0.01201, 0.012627680317496573, 0.01201)
geometry.add_edge(0.012627680317496573, 0.01201, 0.012627680317496573, 0.01051)
geometry.add_edge(0.016146818248309526, 0.01201, 0.017146818248309527, 0.01201)
geometry.add_edge(0.017146818248309527, 0.01201, 0.017146818248309527, 0.01351)
geometry.add_edge(0.017146818248309527, 0.01351, 0.016146818248309526, 0.01351)
geometry.add_edge(0.016146818248309526, 0.01351, 0.016146818248309526, 0.01201)
geometry.add_edge(0.008606609264630475, 0.01351, 0.009606609264630476, 0.01351)
geometry.add_edge(0.009606609264630476, 0.01351, 0.009606609264630476, 0.015009999999999999)
geometry.add_edge(0.009606609264630476, 0.015009999999999999, 0.008606609264630475, 0.015009999999999999)
geometry.add_edge(0.008606609264630475, 0.015009999999999999, 0.008606609264630475, 0.01351)

# BLOCK LABELS
geometry.add_label(0.008689241303364487, 0.00076, materials = {'magnetic' : 'turn_0'})
labels.append((0.008689241303364487, 0.00076))
geometry.add_label(0.007520029390105492, 0.0022600000000000003, materials = {'magnetic' : 'turn_1'})
labels.append((0.007520029390105492, 0.0022600000000000003))
geometry.add_label(0.013662012651098834, 0.0037600000000000003, materials = {'magnetic' : 'turn_2'})
labels.append((0.013662012651098834, 0.0037600000000000003))
geometry.add_label(0.02515634001044162, 0.00526, materials = {'magnetic' : 'turn_3'})
labels.append((0.02515634001044162, 0.00526))
geometry.add_label(0.02059299556957649, 0.0067599999999999995, materials = {'magnetic' : 'turn_4'})
labels.append((0.02059299556957649, 0.0067599999999999995))
geometry.add_label(0.010028631008850021, 0.008259999999999998, materials = {'magnetic' : 'turn_5'})
labels.append((0.010028631008850021, 0.008259999999999998))
geometry.add_label(0.013587186688659693, 0.00976, materials = {'magnetic' : 'turn_6'})
labels.append((0.013587186688659693, 0.00976))
geometry.add_label(0.013127680317496573, 0.011260000000000001, materials = {'magnetic' : 'turn_7'})
labels.append((0.013127680317496573, 0.011260000000000001))
geometry.add_label(0.016646818248309526, 0.01276, materials = {'magnetic' : 'turn_8'})
labels.append((0.016646818248309526, 0.01276))
geometry.add_label(0.009106609264630475, 0.014259999999999998, materials = {'magnetic' : 'turn_9'})
labels.append((0.009106609264630475, 0.014259999999999998))
...
f = open(r"/home/kuczmann/ESCO2022-TEAM35/src/snapshots/9c3793a1-9de3-4f32-8921-a2c0e2439853/S_9c3793a1-9de3-4f32-8921-a2c0e2439853.csv", "w")
