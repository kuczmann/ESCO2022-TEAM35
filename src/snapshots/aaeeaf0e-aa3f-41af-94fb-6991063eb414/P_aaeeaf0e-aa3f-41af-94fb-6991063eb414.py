...
geometry.add_edge(0.00944660829467829, 1e-05, 0.010446608294678288, 1e-05)
geometry.add_edge(0.010446608294678288, 1e-05, 0.010446608294678288, 0.00151)
geometry.add_edge(0.010446608294678288, 0.00151, 0.00944660829467829, 0.00151)
geometry.add_edge(0.00944660829467829, 0.00151, 0.00944660829467829, 1e-05)
geometry.add_edge(0.008192308739881502, 0.00151, 0.009192308739881503, 0.00151)
geometry.add_edge(0.009192308739881503, 0.00151, 0.009192308739881503, 0.00301)
geometry.add_edge(0.009192308739881503, 0.00301, 0.008192308739881502, 0.00301)
geometry.add_edge(0.008192308739881502, 0.00301, 0.008192308739881502, 0.00151)
geometry.add_edge(0.012598411309364723, 0.00301, 0.013598411309364723, 0.00301)
geometry.add_edge(0.013598411309364723, 0.00301, 0.013598411309364723, 0.00451)
geometry.add_edge(0.013598411309364723, 0.00451, 0.012598411309364723, 0.00451)
geometry.add_edge(0.012598411309364723, 0.00451, 0.012598411309364723, 0.00301)
geometry.add_edge(0.00921937643926473, 0.00451, 0.010219376439264731, 0.00451)
geometry.add_edge(0.010219376439264731, 0.00451, 0.010219376439264731, 0.00601)
geometry.add_edge(0.010219376439264731, 0.00601, 0.00921937643926473, 0.00601)
geometry.add_edge(0.00921937643926473, 0.00601, 0.00921937643926473, 0.00451)
geometry.add_edge(0.005812077195295919, 0.00601, 0.006812077195295919, 0.00601)
geometry.add_edge(0.006812077195295919, 0.00601, 0.006812077195295919, 0.007509999999999999)
geometry.add_edge(0.006812077195295919, 0.007509999999999999, 0.005812077195295919, 0.007509999999999999)
geometry.add_edge(0.005812077195295919, 0.007509999999999999, 0.005812077195295919, 0.00601)
geometry.add_edge(0.008371341541747169, 0.007509999999999999, 0.00937134154174717, 0.007509999999999999)
geometry.add_edge(0.00937134154174717, 0.007509999999999999, 0.00937134154174717, 0.009009999999999999)
geometry.add_edge(0.00937134154174717, 0.009009999999999999, 0.008371341541747169, 0.009009999999999999)
geometry.add_edge(0.008371341541747169, 0.009009999999999999, 0.008371341541747169, 0.007509999999999999)
geometry.add_edge(0.012077748401782353, 0.00901, 0.013077748401782354, 0.00901)
geometry.add_edge(0.013077748401782354, 0.00901, 0.013077748401782354, 0.01051)
geometry.add_edge(0.013077748401782354, 0.01051, 0.012077748401782353, 0.01051)
geometry.add_edge(0.012077748401782353, 0.01051, 0.012077748401782353, 0.00901)
geometry.add_edge(0.012861167742507423, 0.01051, 0.013861167742507424, 0.01051)
geometry.add_edge(0.013861167742507424, 0.01051, 0.013861167742507424, 0.01201)
geometry.add_edge(0.013861167742507424, 0.01201, 0.012861167742507423, 0.01201)
geometry.add_edge(0.012861167742507423, 0.01201, 0.012861167742507423, 0.01051)
geometry.add_edge(0.015310402818506142, 0.01201, 0.016310402818506143, 0.01201)
geometry.add_edge(0.016310402818506143, 0.01201, 0.016310402818506143, 0.01351)
geometry.add_edge(0.016310402818506143, 0.01351, 0.015310402818506142, 0.01351)
geometry.add_edge(0.015310402818506142, 0.01351, 0.015310402818506142, 0.01201)
geometry.add_edge(0.010157113917216427, 0.01351, 0.011157113917216428, 0.01351)
geometry.add_edge(0.011157113917216428, 0.01351, 0.011157113917216428, 0.015009999999999999)
geometry.add_edge(0.011157113917216428, 0.015009999999999999, 0.010157113917216427, 0.015009999999999999)
geometry.add_edge(0.010157113917216427, 0.015009999999999999, 0.010157113917216427, 0.01351)

# BLOCK LABELS
geometry.add_label(0.009946608294678288, 0.00076, materials = {'magnetic' : 'turn_0'})
labels.append((0.009946608294678288, 0.00076))
geometry.add_label(0.008692308739881503, 0.0022600000000000003, materials = {'magnetic' : 'turn_1'})
labels.append((0.008692308739881503, 0.0022600000000000003))
geometry.add_label(0.013098411309364724, 0.0037600000000000003, materials = {'magnetic' : 'turn_2'})
labels.append((0.013098411309364724, 0.0037600000000000003))
geometry.add_label(0.00971937643926473, 0.00526, materials = {'magnetic' : 'turn_3'})
labels.append((0.00971937643926473, 0.00526))
geometry.add_label(0.006312077195295919, 0.0067599999999999995, materials = {'magnetic' : 'turn_4'})
labels.append((0.006312077195295919, 0.0067599999999999995))
geometry.add_label(0.00887134154174717, 0.008259999999999998, materials = {'magnetic' : 'turn_5'})
labels.append((0.00887134154174717, 0.008259999999999998))
geometry.add_label(0.012577748401782354, 0.00976, materials = {'magnetic' : 'turn_6'})
labels.append((0.012577748401782354, 0.00976))
geometry.add_label(0.013361167742507424, 0.011260000000000001, materials = {'magnetic' : 'turn_7'})
labels.append((0.013361167742507424, 0.011260000000000001))
geometry.add_label(0.015810402818506143, 0.01276, materials = {'magnetic' : 'turn_8'})
labels.append((0.015810402818506143, 0.01276))
geometry.add_label(0.010657113917216427, 0.014259999999999998, materials = {'magnetic' : 'turn_9'})
labels.append((0.010657113917216427, 0.014259999999999998))
...
f = open(r"/home/kuczmann/ESCO2022-TEAM35/src/snapshots/aaeeaf0e-aa3f-41af-94fb-6991063eb414/S_aaeeaf0e-aa3f-41af-94fb-6991063eb414.csv", "w")
