...
geometry.add_edge(0.007898103898227595, 1e-05, 0.008898103898227594, 1e-05)
geometry.add_edge(0.008898103898227594, 1e-05, 0.008898103898227594, 0.00151)
geometry.add_edge(0.008898103898227594, 0.00151, 0.007898103898227595, 0.00151)
geometry.add_edge(0.007898103898227595, 0.00151, 0.007898103898227595, 1e-05)
geometry.add_edge(0.006525144910538387, 0.00151, 0.007525144910538387, 0.00151)
geometry.add_edge(0.007525144910538387, 0.00151, 0.007525144910538387, 0.00301)
geometry.add_edge(0.007525144910538387, 0.00301, 0.006525144910538387, 0.00301)
geometry.add_edge(0.006525144910538387, 0.00301, 0.006525144910538387, 0.00151)
geometry.add_edge(0.011995929786002052, 0.00301, 0.012995929786002051, 0.00301)
geometry.add_edge(0.012995929786002051, 0.00301, 0.012995929786002051, 0.00451)
geometry.add_edge(0.012995929786002051, 0.00451, 0.011995929786002052, 0.00451)
geometry.add_edge(0.011995929786002052, 0.00451, 0.011995929786002052, 0.00301)
geometry.add_edge(0.018937233293160487, 0.00451, 0.019937233293160488, 0.00451)
geometry.add_edge(0.019937233293160488, 0.00451, 0.019937233293160488, 0.00601)
geometry.add_edge(0.019937233293160488, 0.00601, 0.018937233293160487, 0.00601)
geometry.add_edge(0.018937233293160487, 0.00601, 0.018937233293160487, 0.00451)
geometry.add_edge(0.01961355325793469, 0.00601, 0.02061355325793469, 0.00601)
geometry.add_edge(0.02061355325793469, 0.00601, 0.02061355325793469, 0.007509999999999999)
geometry.add_edge(0.02061355325793469, 0.007509999999999999, 0.01961355325793469, 0.007509999999999999)
geometry.add_edge(0.01961355325793469, 0.007509999999999999, 0.01961355325793469, 0.00601)
geometry.add_edge(0.009018937087913452, 0.007509999999999999, 0.010018937087913453, 0.007509999999999999)
geometry.add_edge(0.010018937087913453, 0.007509999999999999, 0.010018937087913453, 0.009009999999999999)
geometry.add_edge(0.010018937087913453, 0.009009999999999999, 0.009018937087913452, 0.009009999999999999)
geometry.add_edge(0.009018937087913452, 0.009009999999999999, 0.009018937087913452, 0.007509999999999999)
geometry.add_edge(0.011486775472226297, 0.00901, 0.012486775472226298, 0.00901)
geometry.add_edge(0.012486775472226298, 0.00901, 0.012486775472226298, 0.01051)
geometry.add_edge(0.012486775472226298, 0.01051, 0.011486775472226297, 0.01051)
geometry.add_edge(0.011486775472226297, 0.01051, 0.011486775472226297, 0.00901)
geometry.add_edge(0.011217714542851908, 0.01051, 0.012217714542851907, 0.01051)
geometry.add_edge(0.012217714542851907, 0.01051, 0.012217714542851907, 0.01201)
geometry.add_edge(0.012217714542851907, 0.01201, 0.011217714542851908, 0.01201)
geometry.add_edge(0.011217714542851908, 0.01201, 0.011217714542851908, 0.01051)
geometry.add_edge(0.013607311180508569, 0.01201, 0.014607311180508568, 0.01201)
geometry.add_edge(0.014607311180508568, 0.01201, 0.014607311180508568, 0.01351)
geometry.add_edge(0.014607311180508568, 0.01351, 0.013607311180508569, 0.01351)
geometry.add_edge(0.013607311180508569, 0.01351, 0.013607311180508569, 0.01201)
geometry.add_edge(0.012978140241053402, 0.01351, 0.013978140241053403, 0.01351)
geometry.add_edge(0.013978140241053403, 0.01351, 0.013978140241053403, 0.015009999999999999)
geometry.add_edge(0.013978140241053403, 0.015009999999999999, 0.012978140241053402, 0.015009999999999999)
geometry.add_edge(0.012978140241053402, 0.015009999999999999, 0.012978140241053402, 0.01351)

# BLOCK LABELS
geometry.add_label(0.008398103898227594, 0.00076, materials = {'magnetic' : 'turn_0'})
labels.append((0.008398103898227594, 0.00076))
geometry.add_label(0.007025144910538387, 0.0022600000000000003, materials = {'magnetic' : 'turn_1'})
labels.append((0.007025144910538387, 0.0022600000000000003))
geometry.add_label(0.012495929786002051, 0.0037600000000000003, materials = {'magnetic' : 'turn_2'})
labels.append((0.012495929786002051, 0.0037600000000000003))
geometry.add_label(0.019437233293160487, 0.00526, materials = {'magnetic' : 'turn_3'})
labels.append((0.019437233293160487, 0.00526))
geometry.add_label(0.02011355325793469, 0.0067599999999999995, materials = {'magnetic' : 'turn_4'})
labels.append((0.02011355325793469, 0.0067599999999999995))
geometry.add_label(0.009518937087913452, 0.008259999999999998, materials = {'magnetic' : 'turn_5'})
labels.append((0.009518937087913452, 0.008259999999999998))
geometry.add_label(0.011986775472226298, 0.00976, materials = {'magnetic' : 'turn_6'})
labels.append((0.011986775472226298, 0.00976))
geometry.add_label(0.011717714542851906, 0.011260000000000001, materials = {'magnetic' : 'turn_7'})
labels.append((0.011717714542851906, 0.011260000000000001))
geometry.add_label(0.014107311180508569, 0.01276, materials = {'magnetic' : 'turn_8'})
labels.append((0.014107311180508569, 0.01276))
geometry.add_label(0.013478140241053402, 0.014259999999999998, materials = {'magnetic' : 'turn_9'})
labels.append((0.013478140241053402, 0.014259999999999998))
...
f = open(r"/home/kuczmann/ESCO2022-TEAM35/src/snapshots/08df8c3d-6567-4de7-b89e-9a87f06aa276/S_08df8c3d-6567-4de7-b89e-9a87f06aa276.csv", "w")
