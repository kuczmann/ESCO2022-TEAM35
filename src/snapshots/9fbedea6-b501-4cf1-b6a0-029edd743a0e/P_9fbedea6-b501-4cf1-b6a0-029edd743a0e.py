...
geometry.add_edge(0.010752304152824061, 1e-05, 0.01175230415282406, 1e-05)
geometry.add_edge(0.01175230415282406, 1e-05, 0.01175230415282406, 0.00151)
geometry.add_edge(0.01175230415282406, 0.00151, 0.010752304152824061, 0.00151)
geometry.add_edge(0.010752304152824061, 0.00151, 0.010752304152824061, 1e-05)
geometry.add_edge(0.007581160422296184, 0.00151, 0.008581160422296185, 0.00151)
geometry.add_edge(0.008581160422296185, 0.00151, 0.008581160422296185, 0.00301)
geometry.add_edge(0.008581160422296185, 0.00301, 0.007581160422296184, 0.00301)
geometry.add_edge(0.007581160422296184, 0.00301, 0.007581160422296184, 0.00151)
geometry.add_edge(0.0069487385584449, 0.00301, 0.0079487385584449, 0.00301)
geometry.add_edge(0.0079487385584449, 0.00301, 0.0079487385584449, 0.00451)
geometry.add_edge(0.0079487385584449, 0.00451, 0.0069487385584449, 0.00451)
geometry.add_edge(0.0069487385584449, 0.00451, 0.0069487385584449, 0.00301)
geometry.add_edge(0.018465957319573633, 0.00451, 0.019465957319573634, 0.00451)
geometry.add_edge(0.019465957319573634, 0.00451, 0.019465957319573634, 0.00601)
geometry.add_edge(0.019465957319573634, 0.00601, 0.018465957319573633, 0.00601)
geometry.add_edge(0.018465957319573633, 0.00601, 0.018465957319573633, 0.00451)
geometry.add_edge(0.008223647508304139, 0.00601, 0.00922364750830414, 0.00601)
geometry.add_edge(0.00922364750830414, 0.00601, 0.00922364750830414, 0.007509999999999999)
geometry.add_edge(0.00922364750830414, 0.007509999999999999, 0.008223647508304139, 0.007509999999999999)
geometry.add_edge(0.008223647508304139, 0.007509999999999999, 0.008223647508304139, 0.00601)
geometry.add_edge(0.006475375108275121, 0.007509999999999999, 0.007475375108275121, 0.007509999999999999)
geometry.add_edge(0.007475375108275121, 0.007509999999999999, 0.007475375108275121, 0.009009999999999999)
geometry.add_edge(0.007475375108275121, 0.009009999999999999, 0.006475375108275121, 0.009009999999999999)
geometry.add_edge(0.006475375108275121, 0.009009999999999999, 0.006475375108275121, 0.007509999999999999)
geometry.add_edge(0.013719879590519322, 0.00901, 0.014719879590519323, 0.00901)
geometry.add_edge(0.014719879590519323, 0.00901, 0.014719879590519323, 0.01051)
geometry.add_edge(0.014719879590519323, 0.01051, 0.013719879590519322, 0.01051)
geometry.add_edge(0.013719879590519322, 0.01051, 0.013719879590519322, 0.00901)
geometry.add_edge(0.00792717965998723, 0.01051, 0.008927179659987228, 0.01051)
geometry.add_edge(0.008927179659987228, 0.01051, 0.008927179659987228, 0.01201)
geometry.add_edge(0.008927179659987228, 0.01201, 0.00792717965998723, 0.01201)
geometry.add_edge(0.00792717965998723, 0.01201, 0.00792717965998723, 0.01051)
geometry.add_edge(0.015721693228287714, 0.01201, 0.016721693228287714, 0.01201)
geometry.add_edge(0.016721693228287714, 0.01201, 0.016721693228287714, 0.01351)
geometry.add_edge(0.016721693228287714, 0.01351, 0.015721693228287714, 0.01351)
geometry.add_edge(0.015721693228287714, 0.01351, 0.015721693228287714, 0.01201)
geometry.add_edge(0.017573723937147925, 0.01351, 0.018573723937147926, 0.01351)
geometry.add_edge(0.018573723937147926, 0.01351, 0.018573723937147926, 0.015009999999999999)
geometry.add_edge(0.018573723937147926, 0.015009999999999999, 0.017573723937147925, 0.015009999999999999)
geometry.add_edge(0.017573723937147925, 0.015009999999999999, 0.017573723937147925, 0.01351)

# BLOCK LABELS
geometry.add_label(0.01125230415282406, 0.00076, materials = {'magnetic' : 'turn_0'})
labels.append((0.01125230415282406, 0.00076))
geometry.add_label(0.008081160422296185, 0.0022600000000000003, materials = {'magnetic' : 'turn_1'})
labels.append((0.008081160422296185, 0.0022600000000000003))
geometry.add_label(0.0074487385584449005, 0.0037600000000000003, materials = {'magnetic' : 'turn_2'})
labels.append((0.0074487385584449005, 0.0037600000000000003))
geometry.add_label(0.018965957319573633, 0.00526, materials = {'magnetic' : 'turn_3'})
labels.append((0.018965957319573633, 0.00526))
geometry.add_label(0.00872364750830414, 0.0067599999999999995, materials = {'magnetic' : 'turn_4'})
labels.append((0.00872364750830414, 0.0067599999999999995))
geometry.add_label(0.0069753751082751204, 0.008259999999999998, materials = {'magnetic' : 'turn_5'})
labels.append((0.0069753751082751204, 0.008259999999999998))
geometry.add_label(0.014219879590519322, 0.00976, materials = {'magnetic' : 'turn_6'})
labels.append((0.014219879590519322, 0.00976))
geometry.add_label(0.008427179659987228, 0.011260000000000001, materials = {'magnetic' : 'turn_7'})
labels.append((0.008427179659987228, 0.011260000000000001))
geometry.add_label(0.016221693228287714, 0.01276, materials = {'magnetic' : 'turn_8'})
labels.append((0.016221693228287714, 0.01276))
geometry.add_label(0.018073723937147925, 0.014259999999999998, materials = {'magnetic' : 'turn_9'})
labels.append((0.018073723937147925, 0.014259999999999998))
...
f = open(r"/home/kuczmann/ESCO2022-TEAM35/src/snapshots/9fbedea6-b501-4cf1-b6a0-029edd743a0e/S_9fbedea6-b501-4cf1-b6a0-029edd743a0e.csv", "w")
