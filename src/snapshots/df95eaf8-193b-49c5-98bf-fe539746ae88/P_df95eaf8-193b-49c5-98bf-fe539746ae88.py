...
geometry.add_edge(0.009135425607371687, 1e-05, 0.010135425607371688, 1e-05)
geometry.add_edge(0.010135425607371688, 1e-05, 0.010135425607371688, 0.00151)
geometry.add_edge(0.010135425607371688, 0.00151, 0.009135425607371687, 0.00151)
geometry.add_edge(0.009135425607371687, 0.00151, 0.009135425607371687, 1e-05)
geometry.add_edge(0.007525043586274626, 0.00151, 0.008525043586274626, 0.00151)
geometry.add_edge(0.008525043586274626, 0.00151, 0.008525043586274626, 0.00301)
geometry.add_edge(0.008525043586274626, 0.00301, 0.007525043586274626, 0.00301)
geometry.add_edge(0.007525043586274626, 0.00301, 0.007525043586274626, 0.00151)
geometry.add_edge(0.025102403589572213, 0.00301, 0.026102403589572214, 0.00301)
geometry.add_edge(0.026102403589572214, 0.00301, 0.026102403589572214, 0.00451)
geometry.add_edge(0.026102403589572214, 0.00451, 0.025102403589572213, 0.00451)
geometry.add_edge(0.025102403589572213, 0.00451, 0.025102403589572213, 0.00301)
geometry.add_edge(0.025136283017730555, 0.00451, 0.026136283017730556, 0.00451)
geometry.add_edge(0.026136283017730556, 0.00451, 0.026136283017730556, 0.00601)
geometry.add_edge(0.026136283017730556, 0.00601, 0.025136283017730555, 0.00601)
geometry.add_edge(0.025136283017730555, 0.00601, 0.025136283017730555, 0.00451)
geometry.add_edge(0.010083743771818816, 0.00601, 0.011083743771818817, 0.00601)
geometry.add_edge(0.011083743771818817, 0.00601, 0.011083743771818817, 0.007509999999999999)
geometry.add_edge(0.011083743771818817, 0.007509999999999999, 0.010083743771818816, 0.007509999999999999)
geometry.add_edge(0.010083743771818816, 0.007509999999999999, 0.010083743771818816, 0.00601)
geometry.add_edge(0.00817594419665629, 0.007509999999999999, 0.00917594419665629, 0.007509999999999999)
geometry.add_edge(0.00917594419665629, 0.007509999999999999, 0.00917594419665629, 0.009009999999999999)
geometry.add_edge(0.00917594419665629, 0.009009999999999999, 0.00817594419665629, 0.009009999999999999)
geometry.add_edge(0.00817594419665629, 0.009009999999999999, 0.00817594419665629, 0.007509999999999999)
geometry.add_edge(0.011295108508434147, 0.00901, 0.012295108508434148, 0.00901)
geometry.add_edge(0.012295108508434148, 0.00901, 0.012295108508434148, 0.01051)
geometry.add_edge(0.012295108508434148, 0.01051, 0.011295108508434147, 0.01051)
geometry.add_edge(0.011295108508434147, 0.01051, 0.011295108508434147, 0.00901)
geometry.add_edge(0.011150778557897012, 0.01051, 0.01215077855789701, 0.01051)
geometry.add_edge(0.01215077855789701, 0.01051, 0.01215077855789701, 0.01201)
geometry.add_edge(0.01215077855789701, 0.01201, 0.011150778557897012, 0.01201)
geometry.add_edge(0.011150778557897012, 0.01201, 0.011150778557897012, 0.01051)
geometry.add_edge(0.014492937788015359, 0.01201, 0.01549293778801536, 0.01201)
geometry.add_edge(0.01549293778801536, 0.01201, 0.01549293778801536, 0.01351)
geometry.add_edge(0.01549293778801536, 0.01351, 0.014492937788015359, 0.01351)
geometry.add_edge(0.014492937788015359, 0.01351, 0.014492937788015359, 0.01201)
geometry.add_edge(0.014746633505077043, 0.01351, 0.015746633505077042, 0.01351)
geometry.add_edge(0.015746633505077042, 0.01351, 0.015746633505077042, 0.015009999999999999)
geometry.add_edge(0.015746633505077042, 0.015009999999999999, 0.014746633505077043, 0.015009999999999999)
geometry.add_edge(0.014746633505077043, 0.015009999999999999, 0.014746633505077043, 0.01351)

# BLOCK LABELS
geometry.add_label(0.009635425607371687, 0.00076, materials = {'magnetic' : 'turn_0'})
labels.append((0.009635425607371687, 0.00076))
geometry.add_label(0.008025043586274625, 0.0022600000000000003, materials = {'magnetic' : 'turn_1'})
labels.append((0.008025043586274625, 0.0022600000000000003))
geometry.add_label(0.025602403589572213, 0.0037600000000000003, materials = {'magnetic' : 'turn_2'})
labels.append((0.025602403589572213, 0.0037600000000000003))
geometry.add_label(0.025636283017730556, 0.00526, materials = {'magnetic' : 'turn_3'})
labels.append((0.025636283017730556, 0.00526))
geometry.add_label(0.010583743771818817, 0.0067599999999999995, materials = {'magnetic' : 'turn_4'})
labels.append((0.010583743771818817, 0.0067599999999999995))
geometry.add_label(0.00867594419665629, 0.008259999999999998, materials = {'magnetic' : 'turn_5'})
labels.append((0.00867594419665629, 0.008259999999999998))
geometry.add_label(0.011795108508434148, 0.00976, materials = {'magnetic' : 'turn_6'})
labels.append((0.011795108508434148, 0.00976))
geometry.add_label(0.011650778557897012, 0.011260000000000001, materials = {'magnetic' : 'turn_7'})
labels.append((0.011650778557897012, 0.011260000000000001))
geometry.add_label(0.01499293778801536, 0.01276, materials = {'magnetic' : 'turn_8'})
labels.append((0.01499293778801536, 0.01276))
geometry.add_label(0.015246633505077042, 0.014259999999999998, materials = {'magnetic' : 'turn_9'})
labels.append((0.015246633505077042, 0.014259999999999998))
...
f = open(r"/home/kuczmann/ESCO2022-TEAM35/src/snapshots/df95eaf8-193b-49c5-98bf-fe539746ae88/S_df95eaf8-193b-49c5-98bf-fe539746ae88.csv", "w")
