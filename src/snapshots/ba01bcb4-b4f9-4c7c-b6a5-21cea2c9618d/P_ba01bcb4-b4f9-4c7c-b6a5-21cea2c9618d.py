...
geometry.add_edge(0.014561813224500684, 1e-05, 0.015561813224500683, 1e-05)
geometry.add_edge(0.015561813224500683, 1e-05, 0.015561813224500683, 0.00151)
geometry.add_edge(0.015561813224500683, 0.00151, 0.014561813224500684, 0.00151)
geometry.add_edge(0.014561813224500684, 0.00151, 0.014561813224500684, 1e-05)
geometry.add_edge(0.006633800335351356, 0.00151, 0.007633800335351356, 0.00151)
geometry.add_edge(0.007633800335351356, 0.00151, 0.007633800335351356, 0.00301)
geometry.add_edge(0.007633800335351356, 0.00301, 0.006633800335351356, 0.00301)
geometry.add_edge(0.006633800335351356, 0.00301, 0.006633800335351356, 0.00151)
geometry.add_edge(0.006976989730378207, 0.00301, 0.007976989730378206, 0.00301)
geometry.add_edge(0.007976989730378206, 0.00301, 0.007976989730378206, 0.00451)
geometry.add_edge(0.007976989730378206, 0.00451, 0.006976989730378207, 0.00451)
geometry.add_edge(0.006976989730378207, 0.00451, 0.006976989730378207, 0.00301)
geometry.add_edge(0.02792466724361073, 0.00451, 0.02892466724361073, 0.00451)
geometry.add_edge(0.02892466724361073, 0.00451, 0.02892466724361073, 0.00601)
geometry.add_edge(0.02892466724361073, 0.00601, 0.02792466724361073, 0.00601)
geometry.add_edge(0.02792466724361073, 0.00601, 0.02792466724361073, 0.00451)
geometry.add_edge(0.010262987230068252, 0.00601, 0.011262987230068251, 0.00601)
geometry.add_edge(0.011262987230068251, 0.00601, 0.011262987230068251, 0.007509999999999999)
geometry.add_edge(0.011262987230068251, 0.007509999999999999, 0.010262987230068252, 0.007509999999999999)
geometry.add_edge(0.010262987230068252, 0.007509999999999999, 0.010262987230068252, 0.00601)
geometry.add_edge(0.007498952226273984, 0.007509999999999999, 0.008498952226273983, 0.007509999999999999)
geometry.add_edge(0.008498952226273983, 0.007509999999999999, 0.008498952226273983, 0.009009999999999999)
geometry.add_edge(0.008498952226273983, 0.009009999999999999, 0.007498952226273984, 0.009009999999999999)
geometry.add_edge(0.007498952226273984, 0.009009999999999999, 0.007498952226273984, 0.007509999999999999)
geometry.add_edge(0.013885667073778828, 0.00901, 0.014885667073778829, 0.00901)
geometry.add_edge(0.014885667073778829, 0.00901, 0.014885667073778829, 0.01051)
geometry.add_edge(0.014885667073778829, 0.01051, 0.013885667073778828, 0.01051)
geometry.add_edge(0.013885667073778828, 0.01051, 0.013885667073778828, 0.00901)
geometry.add_edge(0.011286928381112277, 0.01051, 0.012286928381112276, 0.01051)
geometry.add_edge(0.012286928381112276, 0.01051, 0.012286928381112276, 0.01201)
geometry.add_edge(0.012286928381112276, 0.01201, 0.011286928381112277, 0.01201)
geometry.add_edge(0.011286928381112277, 0.01201, 0.011286928381112277, 0.01051)
geometry.add_edge(0.015214492981358928, 0.01201, 0.01621449298135893, 0.01201)
geometry.add_edge(0.01621449298135893, 0.01201, 0.01621449298135893, 0.01351)
geometry.add_edge(0.01621449298135893, 0.01351, 0.015214492981358928, 0.01351)
geometry.add_edge(0.015214492981358928, 0.01351, 0.015214492981358928, 0.01201)
geometry.add_edge(0.014020653229730217, 0.01351, 0.015020653229730216, 0.01351)
geometry.add_edge(0.015020653229730216, 0.01351, 0.015020653229730216, 0.015009999999999999)
geometry.add_edge(0.015020653229730216, 0.015009999999999999, 0.014020653229730217, 0.015009999999999999)
geometry.add_edge(0.014020653229730217, 0.015009999999999999, 0.014020653229730217, 0.01351)

# BLOCK LABELS
geometry.add_label(0.015061813224500682, 0.00076, materials = {'magnetic' : 'turn_0'})
labels.append((0.015061813224500682, 0.00076))
geometry.add_label(0.007133800335351356, 0.0022600000000000003, materials = {'magnetic' : 'turn_1'})
labels.append((0.007133800335351356, 0.0022600000000000003))
geometry.add_label(0.007476989730378206, 0.0037600000000000003, materials = {'magnetic' : 'turn_2'})
labels.append((0.007476989730378206, 0.0037600000000000003))
geometry.add_label(0.02842466724361073, 0.00526, materials = {'magnetic' : 'turn_3'})
labels.append((0.02842466724361073, 0.00526))
geometry.add_label(0.01076298723006825, 0.0067599999999999995, materials = {'magnetic' : 'turn_4'})
labels.append((0.01076298723006825, 0.0067599999999999995))
geometry.add_label(0.007998952226273982, 0.008259999999999998, materials = {'magnetic' : 'turn_5'})
labels.append((0.007998952226273982, 0.008259999999999998))
geometry.add_label(0.014385667073778828, 0.00976, materials = {'magnetic' : 'turn_6'})
labels.append((0.014385667073778828, 0.00976))
geometry.add_label(0.011786928381112276, 0.011260000000000001, materials = {'magnetic' : 'turn_7'})
labels.append((0.011786928381112276, 0.011260000000000001))
geometry.add_label(0.015714492981358928, 0.01276, materials = {'magnetic' : 'turn_8'})
labels.append((0.015714492981358928, 0.01276))
geometry.add_label(0.014520653229730215, 0.014259999999999998, materials = {'magnetic' : 'turn_9'})
labels.append((0.014520653229730215, 0.014259999999999998))
...
f = open(r"/home/kuczmann/ESCO2022-TEAM35/src/snapshots/ba01bcb4-b4f9-4c7c-b6a5-21cea2c9618d/S_ba01bcb4-b4f9-4c7c-b6a5-21cea2c9618d.csv", "w")
